...
// MGB Edit - Did not transfer previous edit; if OAI reasoning models fail, return to the previous 'Old Verson' of MGB Tavern @Line 2941 - Otherwise no changes occurred here
...
//XXXXXXXXXXXXXXXX MGB EDIT THIS IS THE LOCAL TIME IN RESPONSE XXXXXXXXXXXXXXXXXXXXXX
    ...
    async function finishGenerating() {
        ...
        if (isStreamingEnabled() && type !== 'quiet') {
            ...
            if (isStreamFinished) {
                ...
                streamingProcessor = null;
				// MGB EDIT XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
				generate_data = '';	
				// MGB EDIT XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX				
